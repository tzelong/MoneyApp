...
function updateValues() {
  ...
  //alert(bal); xxyybalance=bal;
  //alert(total_deposit); xxyydeposit=total_deposit;
  //alert(total_loan); 
  //alert(balance.innerText);
  //alert(money_plus.innerText);
  //alert(money_minus.innerText);

  xxyybalance=bal;
  xxyydeposit= total_deposit; 
  xxyyloan= total_loan;   /* may need to set xxyyloan to negative */
/* Testing myFunction here*/
/* myFunction(); */
